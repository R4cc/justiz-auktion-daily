  ...
  createServer(
    ...
    async (
      ...
      try {
        ...
        if (['GET', 'HEAD'].includes(request.method) && ['/auctions', '/marketplace', '/market', '/businesses', '/shop', '/inventory', '/profile', '/login', '/register', '/admin', '/leaderboard'].includes(url.pathname)) {
